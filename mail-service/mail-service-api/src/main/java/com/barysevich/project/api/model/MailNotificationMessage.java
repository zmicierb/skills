package com.barysevich.project.api.model;
...
/**
 * Класс представляет собой сообщение, которое отправляются в кафку для mail-service.
 * Содержит информацию, необходимую процессору для отправки письма.
 */
public class MailNotificationMessage
{
    ...
    @JsonCreator
    private MailNotificationMessage(@JsonProperty("notificationId") final UUID notificationId,
    ...
    public boolean equals(final Object o)
    {
        ...
        final MailNotificationMessage that = (MailNotificationMessage) o;
    ...
    public static final class Builder
    {
        ...
        {
            return new MailNotificationMessage(notificationId, messageData, email, notificationType, locale);
        }
    }
}