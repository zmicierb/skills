...
INSERT INTO company_info (id, name, start_date, end_date)
VALUES (1, 'IBA', '2016-11-01', NULL), (2, 'BELHARD', '2010-09-01', '2016-10-30');

INSERT INTO project (id, person_id, position_id, description, result, responsibility, company_id, deleted)
VALUES (1, 1, 1, 'Intranet web-portal for company.', 'Project in progress.', 'Developing portlet.', 1, 0),
  (2, 1, 1, 'Online-shop for sale valuables.', 'First phase is complete.', 'Developing catalog of items.', 1, 0),
  (3, 1, 1, 'Enterprise web-application for flow of documentations.', 'Working project from scratch in tight terms.',
   'Developing functionality for editing and printing documents from web-browser.', 2, 0),
  (4, 1, 1, 'Enterprise web-application for organization with branches in every regional city in Belarus.',
  ...
  (5, 1, 2, 'System integration.', 'All projects are in production.', 'Configuring OS, installing Oracle.', 2, 0);

INSERT INTO ENVIRONMENT_SKILL (id, project_id, skill_id, weight)
